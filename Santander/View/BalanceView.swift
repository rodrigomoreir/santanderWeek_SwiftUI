...
//  Santander
//
//  Created by Rodrigo Alves Moreira on 27/07/23.
//
...
struct BalanceView: View {
    ...
    // @State é um simular ao useState do React, quando o
    // estado desse elemento for atualizado, ele atualizará
    // em todos os outros locais presentes
    ...
    var body: some View {
        ...
        // overlay é onde conseguimos inserir uma View dentro dele
        // .leading é o alinhamento que fica para esquerda
            .overlay(alignment: .topLeading, content: {
                // VStack é nossa view Vertical e é ela quem determina
                // os espaçamentos dos elementos internos
                VStack {
                    VStack (alignment: .leading ) {
                        HStack {
                            ...
                            Text("Saldo disponível")
                                ...
                                .padding(.leading)
                            // kerning é o espaçamento entre as letras
                                .kerning(0.18)
